        ...
        <Container>
          <Stack spacing={5}>
            ...
            <Box>
              ...
              <Typography variant="h5">Useful for:</Typography>

              <Typography variant="h5">1. Points based loyalty</Typography>

              <Typography variant="h5">2. Tiered Membership plans</Typography>

              <Typography variant="h5">3. Cashback scheme</Typography>
            </Box>
          </Stack>
        </Container>
      </div>
