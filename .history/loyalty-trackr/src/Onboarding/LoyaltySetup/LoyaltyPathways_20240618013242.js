          ...
          <Container sx={{ marginTop: "20px" }}>
            <Stack spacing={5}>
              ...
              <Stack direction="column" spacing={3}>
                <Link to="/onboarding/loyalty-setup/loyalty-pathways/points-per-purchase">
                  <Card
                    variant="outlined"
                    sx={{
                  ...
                  >
                    <CardContent>
                      ...
                      <Typography sx={{ color: "white" }}>
                        Customers earn points for purchases, which can be
                ...
                >
                  <CardContent>
                    ...
                    <Typography>
                      Customers receive a percentage of their purchase amount
                      back as a reward.
                    </Typography>
                  </CardContent>
                </Card>
